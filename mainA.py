...
def exibir_dia_da_semana_if(numero):
    ...
    if numero == 1:
        ...
        print('Numéro de dia inválido.Digite um número de 1 a 7')


def brincar_de_para_ou_continua():
    resposta = 'C' # True aqui significa que continua
